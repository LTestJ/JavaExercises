...
public class UnevenTirePressure
{
  public static void main (String[] args)
  {
    ...
    if ( (pressureFrontRt == (pressureFrontLt + 3) ) || (pressureFrontRt == (pressureFrontLt - 3) )
	  && (pressureBackRt == (pressureBackLt + 3) ) || (pressureBackRt == (pressureBackLt - 3)))
