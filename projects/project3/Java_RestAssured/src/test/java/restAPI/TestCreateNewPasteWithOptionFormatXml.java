...
public class TestCreateNewPasteWithOptionFormatXml {
	//Function to create random content
	static int getRandomNum() {
		Random rand = new Random(); 
		return rand.nextInt(1000);		
	}
	//Function to create new paste with random content, format XML
	...
	@Test
	public void testCreateNewPasteWithFormatXml() throws IOException
	{	
