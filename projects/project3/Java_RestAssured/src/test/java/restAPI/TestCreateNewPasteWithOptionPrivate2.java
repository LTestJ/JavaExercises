...
public class TestCreateNewPasteWithOptionPrivate2 {
	//Function to create random content
	static int getRandomNum() {
		Random rand = new Random(); 
		return rand.nextInt(1000);		
	}
	//Function to create new private paste with random content,
	...
	@Test
	public void testCreatePasteWithPrivate2() throws IOException
	{	
