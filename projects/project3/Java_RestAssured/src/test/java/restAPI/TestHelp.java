...
//    public static String deletePaste()                                                                  
//    {                                                                                                                                                
//		RequestSpecification request=RestAssured.given();                                                                                               
//		request.header("Content-Type","application/x-www-form-urlencoded");                                                                             
//		request.body("api_dev_key=6c2e400f5df158b657b692687c0dc347&"                                                                                    
...
//    }
  ...
  //Function to create paste with Json Format
	...
	//Function to create new paste with given content and Xmal format 
	...
	//Function to create new paste with given content and given title
	...
	//Function to create new private paste with given content and private=2
