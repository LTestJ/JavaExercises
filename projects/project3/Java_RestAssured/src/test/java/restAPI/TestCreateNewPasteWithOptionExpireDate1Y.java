...
public class TestCreateNewPasteWithOptionExpireDate1Y {
	//Function to create random content
	static int getRandomNum() {
		Random rand = new Random(); 
		return rand.nextInt(1000);		
	}
	//Function to create new paste with random content, expireDate=1 year
	...
	@Test
	public void testCreateNewPasteWithExpireDate1Y() throws IOException
	{	
