...
public class TestCreateNewPasteWithOptionFormatJson {
	//Function to create random content
	static int getRandomNum() {
		Random rand = new Random(); 
		return rand.nextInt(1000);		
	}
	//Function to create new paste with random content, format Json
	...
	@Test
	public void testCreateNewPasteWithFormatJson() throws IOException
	{	
