...
public class TestCreatePasteFormatXml {
	
	
	@Test
	public void testCreatePasteFormatXml() throws IOException
	{	
		...
		String pasteKey = TestHelp.createPasteFormatXml(content);
		...
		//Step3: verify created paste has the same content and is of Xml format		
      ...
      //Step4: verify created paste has xml format
