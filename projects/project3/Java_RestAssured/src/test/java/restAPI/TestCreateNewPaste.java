...
public class TestCreateNewPaste {
	//Function to create random content
	static int getRandomNum() {
		Random rand = new Random(); 
		return rand.nextInt(1000);		
	}
	//Function to create new paste with random content
    public static String createNewPaste(String content)                                                                  
    {                                                                                                                                                
	...
	@Test
	public void testCreateNewPasteRandomContent() throws IOException
	{	
		...
		String pasteKey = createNewPaste(content);
		...
		//Step3: verify paste -- verify obtained url is a complete url
